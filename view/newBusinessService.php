...
require_once("../controller/BusinessServicesController.php");
session_start();
?>
<!DOCTYPE html>
<html lang="en">
...
<header>
    ...
    <main class="retract">
        <h1>New Business Service</h1>
        <form action='../controller/BusinessServicesController.php' method='post' enctype='multipart/form-data' class="m-4">
